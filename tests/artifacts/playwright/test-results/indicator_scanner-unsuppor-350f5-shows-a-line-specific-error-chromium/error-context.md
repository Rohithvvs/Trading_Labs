...
- Name: indicator_scanner.spec.ts >> unsupported pine shows a line-specific error
- Location: e2e\indicator_scanner.spec.ts:150:1
...
Call log:
  - waiting for getByTestId('btn-new-strategy')
...
- generic [ref=e3]:
  ...
  - generic [ref=e16]:
    ...
    - generic [ref=e48]:
      ...
      - paragraph [ref=e52]: Server reachable (2062ms)
      - generic [ref=e53]:
        - generic [ref=e54]:
