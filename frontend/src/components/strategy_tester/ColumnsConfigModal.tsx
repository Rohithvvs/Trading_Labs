...
const ALL_COLUMNS: { key: string; label: string }[] = [
  ...
  { key: "signal", label: "Signal (BUY/WATCH/REJECT)" },
  { key: "evaluation_date", label: "Scan Date (last bar)" },
  { key: "entry_price", label: "Window Start Close" },
  { key: "exit_price", label: "Close (last bar)" },
  { key: "high_252", label: "Prior 252-Session High" },
  { key: "return_pct", label: "Hold Return % (window)" },
  { key: "rsi", label: "RSI" },
