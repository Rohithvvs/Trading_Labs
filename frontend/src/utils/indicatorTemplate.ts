/** Canonical 52-Week High Breakout [SCAN] template used by the Indicator tab. */

export const BREAKOUT_SCAN_TITLE = "52-Week High Breakout [SCAN]";

export const BREAKOUT_SCAN_DESCRIPTION =
  "Daily 52-week high breakout with volume confirmation and a NIFTY 500 market gate.";

export const DEFAULT_INDICATOR_TEMPLATE = `//@version=6
...
export const INDICATOR_SYNTAX_HELP = [
  ...
  "OHLCV: open, high, low, close, volume and close[1]-style indexing",
  ...
  "na(x), nz(x, replacement=0), request.security(symbol, timeframe.period, expr)",
